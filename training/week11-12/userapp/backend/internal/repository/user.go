...
import (
	...
	dao2 "gitlab.xchch.top/golang-group/go-101/training/week11-12/userapp/backend/internal/repository/dao"
...
func NewUserRepository(dao dao2.UserDAO, c cache.Cache) UserRepository {
...
func (c *cacheUserRepository) GetUserById(ctx context.Context, id uint64) (entity.User, error) {
	...
	if errors.Is(err, dao2.ErrNoRows) {
